    ...
    config: {
        ...
        validate: {
            payload: {
                ...
                btcprice: Joi.number().integer().greater(50),
                }),
    ...
    handler: function (request, reply) {
        var options = {
            ...
            metadata: { 
                ...
                'BTCAddress': request.payload.metadata.btcaddress
                'BTCAmount': request.payload.metadata.btcamount
                'BTCPrice': request.payload.metadata.btcprice
            }
        }
